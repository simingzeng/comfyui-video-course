...
```text
【1. 首席大画家】   ➔ UNet 加载器 (扩散模型主脑，脑子里装着顶级写实质感与艺术灵魂)
【2. 需求翻译官】   ➔ 加载CLIP + CLIP文本编码 (阿里 Qwen 3.4B 语言大脑，把中文翻译成画家指令)
【3. 画框置景师】   ➔ 空Latent图像 (根据导演要求裁剪画框比例，如 21:9 电影画幅)
【4. 执笔主画手】   ➔ 采样算法 AuraFlow + K 采样器 (核心画笔，在空白画布上极速去噪擦出画面)
【5. 暗房显影师】   ➔ 加载VAE + VAE解码 + 保存图像 (将数学潜空间解密冲洗为高清真彩 PNG 并装裱存盘)
```
